      ...
      <aside className="w-56 shrink-0 bg-white border-r border-[#e7e2d9] flex flex-col h-screen sticky top-0">
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          ...
          {isOrgAdmin && (
            <Link
              href="/admin/org"
              className="flex items-center gap-2.5 px-3 py-2 rounded-lg text-stone-500 hover:bg-stone-50 hover:text-stone-800 text-sm transition-colors mt-2 border-t border-[#e7e2d9] pt-3"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
